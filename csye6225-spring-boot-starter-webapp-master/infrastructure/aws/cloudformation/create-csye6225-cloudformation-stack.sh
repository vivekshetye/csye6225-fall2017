...
#aws cloudformation create-stack --stack-name stack2 --template-body file:///home/patilmihir/Assignment_3/csye6225-fall2017/csye6225-spring-boot-starter-webapp-master/infrastructure/aws/cloudformation/stack-template.json --parameters ParameterKey=imgId,ParameterValue=ami-cd0f5cb6 ParameterKey=stackName,ParameterValue=stack1  ParameterKey=region,ParameterValue=us-east-1  ParameterKey=vpcId,ParameterValue=vpc-2433d45c ParameterKey=keyName,ParameterValue=id_rsa ParameterKey=InstType,ParameterValue=t2.micro ParameterKey=volumeSize,ParameterValue=16 ParameterKey=volumeType,ParameterValue=gp2 ParameterKey=hostedZoneId,ParameterValue=Z31TTYNFTW06J1 ParameterKey=dnsName,ParameterValue=ec2.csye6225-fall2017-patilm.me ParameterKey=recordSetType,ParameterValue=A ParameterKey=recordSetTTL,ParameterValue=60
