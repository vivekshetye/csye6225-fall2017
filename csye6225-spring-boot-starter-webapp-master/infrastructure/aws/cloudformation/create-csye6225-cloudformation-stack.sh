...
#aws cloudformation create-stack --stack-name stack2 --template-body file:///home/vivek/csye6225-fall2017/csye6225-spring-boot-starter-webapp-master/infrastructure/aws/cloudformation/stack-template.json --parameters ParameterKey=imgId,ParameterValue=ami-cd0f5cb6 ParameterKey=vpcId,ParameterValue=vpc-303dda48 ParameterKey=keyName,ParameterValue=id_rsa ParameterKey=InstType,ParameterValue=t2.micro ParameterKey=volumeSize,ParameterValue=16 ParameterKey=volumeType,ParameterValue=gp2 ParameterKey=hostedZoneId,ParameterValue=Z3R9EHLZXTUWNU ParameterKey=dnsName,ParameterValue=ec2.csye6225-fall2017-shetyev.me ParameterKey=recordSetType,ParameterValue=A ParameterKey=recordSetTTL,ParameterValue=60 ParameterKey=rdsParamUsername,ParameterValue=csye6225master ParameterKey=rdsParamPassword,ParameterValue=csye6225password 
